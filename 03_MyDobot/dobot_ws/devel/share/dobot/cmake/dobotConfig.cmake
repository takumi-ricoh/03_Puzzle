...
if("TRUE" STREQUAL "TRUE")
  set(dobot_SOURCE_PREFIX /home/waida/MyDobot/dobot_ws/src/dobot)
  set(dobot_DEVEL_PREFIX /home/waida/MyDobot/dobot_ws/devel)
  set(dobot_INSTALL_PREFIX "")
  set(dobot_PREFIX ${dobot_DEVEL_PREFIX})
else()
  set(dobot_SOURCE_PREFIX "")
  set(dobot_DEVEL_PREFIX "")
  set(dobot_INSTALL_PREFIX /home/waida/MyDobot/dobot_ws/install)
...
if(NOT "/home/waida/MyDobot/dobot_ws/devel/include " STREQUAL " ")
  set(dobot_INCLUDE_DIRS "")
  set(_include_dirs "/home/waida/MyDobot/dobot_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dobot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Luke <liuzhufu@dobot.cc>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/waida/MyDobot/dobot_ws/src/dobot/${idir}'.  Ask the maintainer 'Luke <liuzhufu@dobot.cc>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/waida/MyDobot/dobot_ws/devel/lib;/home/waida/MyDobot/dobot_ws/devel/lib;/opt/ros/kinetic/lib)
